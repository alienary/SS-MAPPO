...
def cityflow2sumo_flow(args):
    # parent dir of current dir
    f_cwd = os.path.abspath(os.path.dirname(os.getcwd()) + os.path.sep + ".")
    sumofile = os.path.join(f_cwd, 'data', args.sumotraffic)
    cityflowfile = os.path.join(f_cwd, 'data', args.or_cityflowtraffic)
...
def cityflow2sumo_net(args):
    ...
    # parent dir of current dir
    f_cwd = os.path.abspath(os.path.dirname(os.getcwd()) + os.path.sep + ".")
    sumofile = os.path.join(f_cwd, 'data', args.sumonet)
    cityflowfile = os.path.join(f_cwd, 'data', args.or_cityflownet)
